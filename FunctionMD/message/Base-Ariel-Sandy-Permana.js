...
if (q.includes('--help')) return reply(examquery) 
  ...
  break
  case 'hartatahta':
if (!q) return reply(`Penggunaan *${order}*\n\nContoh : ${prefix + order} ${Options.info.ownerName}`)
reply(`Tunggu Bro`)
sock.sendMessage(from, {caption: `*Nih Dek*`, image: { url: `https://zenzapis.xyz/creator/hartatahta?apikey=dc311285aa&text=${q}`}}, {quoted: m})
break
case 'hinata':
  reply('Tunggu')
  sock.sendMessage(from, {caption: `*Nih Buat Wallpaper*`, image: { url: `https://zenzapis.xyz/randomanime/v2/hinata?apikey=dc311285aa&text=${q}`}}, {quoted: m})
  break
case 'onepiece':
reply('Tunggu')
